...
#
TLIBS = -lm -lm -ldl -lz -lpthread  $(LIBS)
...
OPT_FEATURE_FLAGS =  -DSQLITE_ENABLE_MEMSYS5 -DSQLITE_ENABLE_FTS3 -DSQLITE_ENABLE_FTS4 -DSQLITE_ENABLE_FTS5 -DSQLITE_ENABLE_JSON1 -DSQLITE_ENABLE_GEOPOLY -DSQLITE_ENABLE_RTREE -DSQLITE_ENABLE_SESSION -DSQLITE_ENABLE_PREUPDATE_HOOK
